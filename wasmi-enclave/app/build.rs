...
fn main () {
    ...
    match is_sim.as_ref() {
        "SW" => println!("cargo:rustc-link-lib=dylib=sgx_ukey_exchange_sim"),
        "HW" => println!("cargo:rustc-link-lib=dylib=sgx_ukey_exchange"),
        _    => println!("cargo:rustc-link-lib=dylib=sgx_ukey_exchange"), // Treat undefined as HW
    }
}
